...
export enum AUTH_MESSAGES  {
    ...
    WELCOME_BETA_MESSAGE = "Welcome to Djangoly (Beta)! 👋 By using this extension, you agree to our Terms of Service and Privacy Policy.",
    INVALID_API_KEY = "The API key you entered is invalid. Please try again or request a new API key using the form below.",
    AUTHENTICATION_REQUIRED = "Authentication is required to use Djangoly. Please sign in or request an API key.",
    SIGN_OUT = "You have deactivated Djangoly. To reactivate, use the 'Djangoly: Sign In' command or restart your IDE. See ya! 👋",
