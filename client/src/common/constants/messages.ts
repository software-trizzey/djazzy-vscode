...
export enum AUTH_MESSAGES  {
    ...
    SIGN_IN_FAILURE = "Failed to sign in to Djangoly. Please try again or contact support at support@djazzy.com",
    ...
    LEGACY_AUTH_FAILED = "Your API key authentication has failed. Please sign in with GitHub to continue using Djangoly. If you need help migrating, contact support@djazzy.com",
