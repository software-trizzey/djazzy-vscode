...
class Issue(object):
    ...
    def __init__(self, lineno, col, severity = IssueSeverity.WARNING, parameters=None):
        self.parameters = {} if parameters is None else parameters
        self.col = col
        self.lineno = lineno
        self.severity = severity
        
        if 'end_col_offset' in self.parameters:
            self.end_col = self.parameters['end_col_offset']
