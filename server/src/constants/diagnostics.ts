export const SOURCE_NAME = "when-in-rome";
...
export const DJANGO_BEST_PRACTICES_VIOLATION_SOURCE_TYPE = "django-best-practices-violation";
export const DJANGO_NPLUSONE_VIOLATION_SOURCE_TYPE = "django-nplusone-query-violation";
