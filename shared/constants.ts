...
export const PRIVACY_POLICY_URL = "https://djazzy.dev/privacy.html";
export const TERMS_OF_SERVICE_URL = "https://djazzy.dev/terms.html";
...
export const TELEMETRY_EVENTS = {
    ...
    API_KEY_VALIDATION_ERROR: `${EXTENSION_ID_WITH_PUBLISHER}.apiKeyValidationError`,
    ...
    LEGACY_USER_POSTPONED: `${EXTENSION_ID_WITH_PUBLISHER}.legacyUserPostponed`,
    LEGACY_USER_REMINDER_SKIPPED: `${EXTENSION_ID_WITH_PUBLISHER}.legacyUserReminderSkipped`,
} as const;
